...
geography = st.selectbox('Geography', encode_hot.categories_[0])
gender = st.selectbox('Gender', encode_label.classes_)
...
input_data = pd.DataFrame({
    ...
    'Gender': [encode_label.transform([gender])[0]],
    'Age': [age],
    'Tenure': [tenure],
    'Balance': [balance],
...
input_data_scaled = scaled.transform(input_data)
